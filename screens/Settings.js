...
import { SafeAreaView, StyleSheet, TextInput, Text, Button, Image, ScrollView, ActivityIndicator } from 'react-native';
    ...
    return (
      <SafeAreaView style={styles.background1}>
        <ScrollView>
          ...
          {/* Aquí puedes agregar el contenido del menú de configuración */}
            <Text style={styles.textochico} >Colores</Text>
            <Text style={styles.textochico} ></Text>
            <Text style={styles.textochico} >Notificaciones</Text>
            <Text style={styles.textochico} >Ayuda</Text>
